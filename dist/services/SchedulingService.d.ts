...
export declare class SchedulingService {
    ...
    private getAvailableFixedTeams;
    private matchupKey;
    private buildTeamRematchCounts;
    private findBestFixedMatchup;
    private compareFixedAssignments;
    private buildFixedWarning;
    private buildSinglesWarning;
    private compareSinglesAssignments;
    private static readonly SINGLES_MAX_CONSECUTIVE_GAMES;
    private static readonly SINGLES_BACK_TO_BACK_PROMOTE_CHANCE;
    private isSinglesResting;
    private resetSinglesRestStreaks;
    /** Singles only: 25% chance to promote one finisher; never re-promote wasBackToBack; prefer fewer games. */
    private applySinglesEndGamePriority;
    /**
