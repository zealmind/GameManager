...
export declare class Database {
    ...
    private migrateAddEventFormat;
    private migrateAddFixedPartnerId;
    private migrateAddConsecutiveGamesPlayed;
     ...
     */
    persistGameScore(gameId: string, scores: [number, number] | undefined): Promise<void>;
    /**
     ...
     */
    persistGameState(game: Game, inHistory: boolean): Promise<void>;
    /**
     ...
     */
    persistRegistrations(eventId: string, playerIds: string[]): Promise<void>;
    /**
     ...
     */
    persistNewGame(game: Game, inHistory: boolean): Promise<void>;
    /**
    ...
    createEvent(name: string, totalGamesToPlay: number, numCourts: number, ownerId: string, format?: EventFormat): Promise<Event>;
    /**
